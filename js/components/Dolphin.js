...
export default function ({ data }) {
    ...
    return (
        <>
            <ViroNode>
                <Viro3DObject
                    source={require('../res/animal/dolphin/dolphin.obj')}
                    resources={[
                        require('../res/animal/dolphin/10014_dolphin_v2_max2011_it2.mtl'),
                        require('../res/animal/dolphin/10014_dolphin_v1_Diffuse.jpg'),
                    ]}
                    position={position}
