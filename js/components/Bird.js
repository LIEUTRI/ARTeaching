...
export default function ({ data }) {
    ...
    return (
        <>
            <ViroNode>
                <Viro3DObject
                    source={require('../res/animal/bird/bird.obj')}
                    resources={[require('../res/animal/bird/12213_Bird_v1_l3.mtl'),
                    require('../res/animal/bird/12213_bird_diffuse.jpg'),
                    require('../res/animal/bird/Map__7_Normal Bump.jpg'),
                    ]}
                    position={position}
